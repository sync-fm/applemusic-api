...
import { Resource, AlbumAttributes, GenericAttributes, SongAttributes, PlaylistAttributes, CuratorAttributes, MusicVideoAttributes, UploadedVideoAttributes, StationAttributes, ArtistAttributes } from "../../types/SharedResourceTypes";
...
export const SearchEndpointParamsDefaults: SearchEndpointParams = {
    types: [
        ResourceType.Activities, ResourceType.Albums, ResourceType.AppleCurators, ResourceType.Artists, ResourceType.Curators, ResourceType.EditorialItems, ResourceType.MusicMovies, ResourceType.MusicVideos, ResourceType.Playlists, ResourceType.RecordLabels, ResourceType.Songs, ResourceType.Stations, ResourceType.TVEpisodes, ResourceType.UploadedVideos
    ],
    with: [
        WithOption.LyricHighlights, WithOption.Lyrics, WithOption.NaturalLanguage, WithOption.ServerBubbles, WithOption.Subtitles
    ],
    ...
    fields: {
        albums: [
            FieldsAlbums.ArtistName, FieldsAlbums.ArtistUrl, FieldsAlbums.Artwork, FieldsAlbums.ContentRating, FieldsAlbums.EditorialArtwork,
            FieldsAlbums.EditorialNotes, FieldsAlbums.Name, FieldsAlbums.PlayParams, FieldsAlbums.ReleaseDate, FieldsAlbums.URL, FieldsAlbums.TrackCount
        ],
        artists: [
...
export interface SearchEndpointResponse {
    ...
    resources?: Record<string, Record<string, Resource<any>>>;
