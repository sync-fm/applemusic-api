import { ExtendOption, SuggestionsEndpointParams, SuggestionsEndpointParamsDefaults } from "./types";
...
export function buildSearchQuery(params: SuggestionsEndpointParams, encode: boolean = true, includeDefaults: boolean = true): string {
