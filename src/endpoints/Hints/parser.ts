import { ExtendOption, HintsEndpointParams, HintsEndpointParamsDefaults } from "./types";
...
export function buildSearchQuery(params: HintsEndpointParams, encode: boolean = true, includeDefaults: boolean = true): string {
