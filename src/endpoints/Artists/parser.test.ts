...
describe("artists parser", () => {
    test("parseArtistParams filters and normalises values", () => {
        ...
        expect(result).toEqual({
            ...
            platform: Platform.IOS,
            l: Locale.FR_FR,
            include: [IncludeOption.Albums, IncludeOption.Genres, IncludeOption.MusicVideos, IncludeOption.Station],
    ...
    test("buildArtistQuery respects custom defaults", () => {
        const query = buildArtistQuery({}, true, true, { ...ArtistViewParamsDefaults });
