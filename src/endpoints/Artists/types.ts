...
export type ArtistAlbumResource = Resource<AlbumAttributes> & { type: "albums" };
export type ArtistPlaylistResource = Resource<PlaylistAttributes> & { type: "playlists" };
export type ArtistMusicVideoResource = Resource<MusicVideoAttributes> & { type: "music-videos" };
export type ArtistSongResource = Resource<SongAttributes> & { type: "songs" };
export type ArtistSimilarArtistResource = Resource<ArtistAttributes> & { type: "artists" };
export type ArtistStationResource = Resource<StationAttributes> & { type: "stations" };
...
export interface ArtistRelationships {
    ...
    "music-videos"?: RelationshipWithRefs<RelationshipRef & { attributes?: MusicVideoAttributes }>;
    playlists?: RelationshipWithRefs<RelationshipRef & { attributes?: PlaylistAttributes }>;
    station?: RelationshipWithRefs<RelationshipRef & { attributes?: StationAttributes }>;
    [k: string]: RelationshipWithRefs | undefined;
}

export interface ArtistViews {
    "appears-on-albums"?: RelationshipWithResources<ArtistViewResourceMap["appears-on-albums"]>;
    "compilation-albums"?: RelationshipWithResources<ArtistViewResourceMap["compilation-albums"]>;
    "featured-albums"?: RelationshipWithResources<ArtistViewResourceMap["featured-albums"]>;
    "featured-music-videos"?: RelationshipWithResources<ArtistViewResourceMap["featured-music-videos"]>;
    "featured-playlists"?: RelationshipWithResources<ArtistViewResourceMap["featured-playlists"]>;
    "full-albums"?: RelationshipWithResources<ArtistViewResourceMap["full-albums"]>;
    "latest-release"?: RelationshipWithResources<ArtistViewResourceMap["latest-release"]>;
    "live-albums"?: RelationshipWithResources<ArtistViewResourceMap["live-albums"]>;
    "similar-artists"?: RelationshipWithResources<ArtistViewResourceMap["similar-artists"]>;
    "singles"?: RelationshipWithResources<ArtistViewResourceMap["singles"]>;
    "top-music-videos"?: RelationshipWithResources<ArtistViewResourceMap["top-music-videos"]>;
...
export interface ArtistViewOptions extends ArtistRequestOptions {
    limit?: number;
}
...
export interface ArtistRelationshipParams extends ArtistViewOptions {
    id: string;
...
export const ArtistRelationshipParamsDefaults: ArtistViewOptions = {
    ...ArtistParamsDefaults,
    limit: 25,
};
...
export interface ArtistsRelationshipResponse<T extends ArtistRelationshipName = ArtistRelationshipName> {
